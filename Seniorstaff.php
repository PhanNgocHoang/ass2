...
<body>
    <header>
            ...
            <a href="createacc.php"><button class= "btn btn-primary">Create Accout for Store</button></a>
            <a href="managestore.php"><button class="btn btn-primary">Manage Accout of Store</button></a>
    </header>
    <div class="container">
        <h1>Store 1</h1>
